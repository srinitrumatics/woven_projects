...
export function mapSalesforceProductToLocal(sfProduct: any): Product {
  const mappedProduct: Product = {
    ...
    specifications: {
      ...
      "Sustainability": [
        { label: "Product Availability", value: sfProduct.Product_Availability__c || "0" },
        { label: "Energy Consumption", value: sfProduct.Energy_Consumption__c || "0" },
        { label: "End-of-Life Management", value: sfProduct.End_of_Life_Management__c || "0" },
        { label: "Manufacturing Process", value: sfProduct.Manufacturing_Process__c || "0" },
        { label: "Packaging Materials", value: sfProduct.Packaging_Materials__c || "0" },
        { label: "Product Longevity", value: sfProduct.Product_Longevity__c || "0" },
        { label: "Product Use Emissions", value: sfProduct.Product_Use_Emissions__c || "0" },
        { label: "Water Usage", value: sfProduct.Water_Usage__c || "0" },
      ],
      "Connectivity": [
