...
function buildAlgoliaPayload(row: any) {
  ...
  return {
    ...
    price: Number(row.gtherp__price__c ?? 0),
    listPrice: Number(row.list_price__c ?? 0),
    unitPrice: Number(row.gtherp__price__c ?? 0),
    stock_quantity: Number(row.gtherp__stock_quantity__c ?? 0),
    available_quantity: Number(row.gtherp__available_quantity__c ?? 0),
    discount: Number(row.gtherp__discount__c ?? 0),
    moq: Number(row.gtherp__moq__c ?? 0),
    available_to_sell: Number(row.gtherp__available_to_sell__c ?? 0),
