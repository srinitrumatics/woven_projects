      ...
      if (tab === 'quotelines') {
        ...
        setFulfillmentData({
          invoices: (json.Invoice__c || []).map((inv: any) => ({
            ...
            proposalNumber: inv.Proposal_Number__c || inv.Proposal_Name || '',
          ...
          shippingManifests: (json.Shipping_Manifest__c || []).map((sm: any) => ({
            ...
            proposalNumber: sm.Proposal_Number__c || sm.Proposal_Name || '',
          ...
          salesOrders: (json.Sales_Order__c || []).map((so: any) => ({
            ...
            proposalNumber: so.Proposal_Number__c || so.Proposal_Name || '',
        ...
        setReturnsData({
          rma: (json.RMA__c || []).map((r: any) => ({
            ...
            supplierBillId: r.Supplier_Bill__c || '',
          ...
          creditMemos: (json.Credit_Memo__c || []).map((c: any) => ({
            ...
            proposalNumber: c.Proposal_Number__c || c.Proposal_Name || '',
            ...
            supplierBillId: c.Supplier_Bill__c || '',
            purchaseOrder: c.Purchase_Order_Name || '',
