            ...
            <div className="text-sm">
                <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1 truncate" title="Ship to Account">Ship to Account</label>
                        ...
                        <div>
                            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1 truncate" title="Ship to Location">Ship to Location</label>
                    ...
                    <div>
                        <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1 truncate" title="Shipping Address">Shipping Address</label>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1 truncate" title="Request Date">Request Date</label>
                        ...
                        <div>
                            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1 truncate" title="Drop-Ship">Drop-Ship</label>
                        ...
                        <div>
                            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1 truncate" title="Site">Site</label>
