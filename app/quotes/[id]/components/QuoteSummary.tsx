        ...
        <div className={`bg-white dark:bg-gray-800 rounded-lg p-5 shadow-md border border-gray-200 dark:border-gray-700 w-full flex flex-col h-full ${className}`}>
            <div className="flex items-center gap-3 mb-6 min-w-0">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400"title="Review Quote Summary">Review Quote Summary</p>
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col justify-between pt-2 min-w-0">
                ...
                <div className="flex-1 space-y-4">
                    ...
                    <div className="flex justify-between text-sm gap-4">
                        <span className="text-gray-700 dark:text-gray-300  flex-1"title="Taxes">Taxes</span>
                        <span className="text-gray-900 dark:text-white font-medium shrink-0">{formatCurrency(quote.taxTotal)}</span>
                    </div>

                    <div className="flex justify-between text-sm gap-4">
                        <span className="text-gray-700 dark:text-gray-300  flex-1"title="Shipping">Shipping</span>
                ...
                <div className="mt-auto pt-4">
                    ...
                    <div className="border-t border-gray-300 dark:border-gray-600 pt-3 mt-2">
                        ...
                        <div className="flex justify-between text-sm">
                            <span className="text-gray-700 dark:text-gray-300  flex-1"title="Planned Ship Date">Planned Ship Date</span>
                            <span className="text-gray-700 dark:text-gray-300">
                                {formatDate(quote.plannedShipDate, 'numeric-dash')}
                            </span>
                        </div>
                    </div>
                </div>
