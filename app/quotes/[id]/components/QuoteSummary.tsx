    ...
    return (
        <div className={`bg-white dark:bg-gray-800 rounded-lg p-5 shadow-md border border-gray-200 dark:border-gray-700 w-full flex flex-col h-full ${className}`}>
            <div className="flex items-center gap-3 mb-6 min-w-0">
                ...
                <div>
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-white " title="Quote Summary">Quote Summary</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400 truncate" title="Review Your Quote Summary">Review Your Quote Summary</p>
                </div>
            </div>

            <div className="flex-1 flex flex-col justify-between pt-2 min-w-0">
                {/* Content Area */}
                <div className="flex-1 space-y-4">
                    <div className="flex justify-between text-sm gap-4">
                        ...
                        <span className="text-gray-900 dark:text-white font-medium shrink-0 truncate">{formatCurrency(productsSubtotal)}</span>
                    </div>
                    ...
                    <div className="flex justify-between text-sm gap-4">
                        ...
                        <span className="text-gray-900 dark:text-white font-medium shrink-0 truncate">{formatCurrency(quote.serviceTotal)}</span>
                    </div>

                    <div className="flex justify-between text-sm gap-4">
                        <span className="text-gray-700 dark:text-gray-300 truncate flex-1" title="Taxes">Taxes</span>
                        <span className="text-gray-900 dark:text-white font-medium shrink-0 truncate">{formatCurrency(quote.taxTotal)}</span>
                    </div>

                    <div className="flex justify-between text-sm gap-4">
                        <span className="text-gray-700 dark:text-gray-300 truncate flex-1" title="Shipping">Shipping</span>
                        <span className="text-gray-900 dark:text-white font-medium shrink-0 truncate">{formatCurrency(quote.shippingCost)}</span>
                    </div>
                </div>
                ...
                <div className="mt-auto pt-4">
                    <div className="border-t-2 border-primary/20 dark:border-primary/40 pt-2">
                        <div className="flex justify-between text-lg font-bold">
                            ...
                            <span className="text-primary dark:text-primary truncate">{formatCurrency(grandTotal)}</span>
                        </div>
                    </div>
