                    ...
                    <Table className="text-sm table-fixed">
                        <THead>
                            <tr>
                                ...
                                <SortableHeader label="Credited Qty" field="creditQty" sortConfig={sortConfig} requestSort={requestSort} width={widths.creditQty} onResize={handleResize} />
                        ...
                        <TBody>
                            {paginatedData.map((item) => (
                                <Tr key={item.id} className="border-b border-gray-200 dark:border-gray-700">
                                    ...
                                    <Td className="truncate" style={{ width: widths.creditMemoName }}>
                                        {displayCell(item.creditMemoName)}
                                    </Td>
                                    ...
                                    <Td className="truncate" style={{ width: widths.creditQty }}>{item.creditQty}</Td>
