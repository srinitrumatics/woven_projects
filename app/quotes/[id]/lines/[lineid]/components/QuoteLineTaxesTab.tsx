                ...
                <Table className="text-sm text-left">
                    ...
                    <TBody>
                        {sortedData.map((tax: TaxData) => (
                            <Tr key={tax.id} className="bg-white dark:bg-gray-800 transition-colors">
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{(tax.salesTaxRate ?? 0).toFixed(3)}%</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{formatCurrency(tax.salesTaxAmount ?? 0)}</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{(tax.useTaxRate ?? 0).toFixed(3)}%</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{formatCurrency(tax.useTaxAmount ?? 0)}</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{(tax.localTaxRate ?? 0).toFixed(3)}%</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{formatCurrency(tax.localTaxAmount ?? 0)}</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{(tax.exciseTaxRate ?? 0).toFixed(3)}%</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{formatCurrency(tax.exciseTaxAmount ?? 0)}</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{(tax.grtRate ?? 0).toFixed(3)}%</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{formatCurrency(tax.grtAmount ?? 0)}</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{(tax.gstRate ?? 0).toFixed(3)}%</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{formatCurrency(tax.gstAmount ?? 0)}</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{(tax.vatRate ?? 0).toFixed(3)}%</Td>
                                <Td className="text-gray-900 dark:text-gray-100 truncate">{formatCurrency(tax.vatAmount ?? 0)}</Td>
                            </Tr>
                        ))}
                    </TBody>
                </Table>
