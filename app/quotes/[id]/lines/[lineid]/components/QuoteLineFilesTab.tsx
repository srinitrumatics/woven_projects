        ...
        <div className="overflow-x-auto">
            {files.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-gray-500 dark:text-gray-400 min-w-0">
                    ...
                    <p className="text-sm truncate">There are no files associated with this quote line.</p>
                </div>
            ) : (
                <>
                    <table className="w-full">
                        <thead className="bg-primary-light dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                            <tr>
                                ...
                                <th className="px-2 py-3 text-left text-sm font-semibold text-gray-900 dark:text-white truncate" style={{ width: widths.action }}>
                                    Action
                                </th>
                            </tr>
                        </thead>
