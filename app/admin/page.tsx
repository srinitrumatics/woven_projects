...
export default function AdminPage() {
  ...
  const showRolesAndPermissions = typeCategory === 'Hybrid' || typeCategory === 'Partner';
    ...
    <ProtectedRoute>
      <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          <Link href="/admin/users" className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 hover:shadow-md transition-shadow truncate">
          ...
          {showRolesAndPermissions && (
            <>
              <Link href="/admin/roles" className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 hover:shadow-md transition-shadow truncate">
                <div className="flex items-center min-w-0">
              ...
              <Link href="/admin/permissions" className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 hover:shadow-md transition-shadow truncate">
                <div className="flex items-center min-w-0">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-300 truncate" title="Start by creating permissions, then roles, and finally assign roles to users.">
