                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4 col-span-2 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700">
                            <label className="flex items-center gap-3 cursor-pointer group">
                                ...
                                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Open 24 Hours</span>
                            </label>
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group">
                                ...
                                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Receive on Federal Holidays</span>
                            </label>
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group">
                                ...
                                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Closed for Deliveries</span>
                            </label>
                        ...
                        {/* Delivery Notes */}
                        <div className="col-span-2">
                            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Delivery Notes</label>
                            <textarea
                    ...
                    <div className="mt-8 flex gap-3 justify-end">
                        <button
                            type="button"
                            onClick={onClose}
                            className="px-6 py-2 border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-all font-medium"
                        >
                            Cancel
                        </button>
                        <button
