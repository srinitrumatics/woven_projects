...
function SummaryRow({ label, value }: { label: string; value: number }) {
    return (
        <div className="flex justify-between items-center text-sm font-medium gap-2 min-w-0">
            ...
            <span className="text-gray-900 dark:text-white whitespace-nowrap truncate">{formatCurrency(value)}</span>
        </div>
    );
}
            ...
            <div className="flex-1 flex flex-col justify-between min-w-0">
                ...
                <div className="mt-auto pt-2 flex flex-col gap-4">
                    <div className="border-t-2 border-b-2 border-primary/20 dark:border-primary/40 pt-1 flex justify-between items-center gap-2">
                        ...
                        <span className="text-lg font-bold text-primary whitespace-nowrap truncate">{formatCurrency(grandTotal)}</span>
                    </div>
