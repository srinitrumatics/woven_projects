        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
          ...
          <div className="p-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <button className="flex flex-col items-center justify-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors truncate">
                ...
                <span className="text-sm font-medium text-gray-900 dark:text-white truncate">View Reports</span>
              </button>
            </div>
          </div>
        </div>
