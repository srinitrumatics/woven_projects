    ...
    return (
        <div className="flex flex-col min-w-0">
            ...
            <div className="flex border-b border-gray-200 dark:border-gray-700 mb-6 font-bold">
                <button
                    className={`px-6 py-3 text-sm font-bold border-b-2 transition-colors ${subTab === 'bill-payments'
                        ? 'border-primary text-primary'
                        : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
                        }`}
                    onClick={() => {
                        setSubTab('bill-payments');
                ...
                <button
                    className={`px-6 py-3 text-sm font-bold border-b-2 transition-colors ${subTab === 'applied-debits'
                        ? 'border-primary text-primary'
                        : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
                        }`}
                    onClick={() => {
                        setSubTab('applied-debits');
                        setCurrentPageDebits(1);
                    }}
                >
                            ...
                            <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
                                <table className="w-full border-separate border-spacing-0 table-fixed">
                                    <thead className="bg-primary-light dark:bg-gray-900 sticky top-0 z-20">
                                        <tr>
                                            <SortableHeader className="sticky left-0 bg-primary-light dark:bg-gray-900 z-30 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)]" label="Bill Payment" field="name" sortConfig={sortConfigPayments} requestSort={requestSortPayments} width={columnWidthsPayments.name} onResize={handleResizePayments} />
                        ...
                        <div className="flex flex-col min-w-0">
                            <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
                                <table className="w-full border-separate border-spacing-0 table-fixed">
                                    <thead className="bg-primary-light dark:bg-gray-900 sticky top-0 z-20">
                                        <tr>
                                            <SortableHeader className="sticky left-0 bg-primary-light dark:bg-gray-900 z-30 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)]" label="Applied Debit Payment" field="name" sortConfig={sortConfigDebits} requestSort={requestSortDebits} width={columnWidthsDebits.name} onResize={handleResizeDebits} />
                                            ...
                                            <SortableHeader label="Availabe Debit Balance" field="availableDebitBalance" sortConfig={sortConfigDebits} requestSort={requestSortDebits} width={columnWidthsDebits.availableDebitBalance} onResize={handleResizeDebits} />
