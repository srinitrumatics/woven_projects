    ...
    return (
        <div className="mb-6">
            <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-6">
                <button onClick={onBack} className="hover:text-gray-700 dark:hover:text-gray-300">Supplier Bills</button>
                <span> &gt;</span>
                <span className="hover:text-gray-700 dark:text-gray-300" title="View Supplier Bill">View Supplier Bill</span>
                <span> &gt;</span>
                <span className="text-gray-900 dark:text-white" title={billNumber}>{billNumber}</span>
            </div>
            ...
            <div className="w-full rounded-lg px-2">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0">
                    <div className="flex items-center gap-4 w-full sm:w-auto">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight" title={billNumber}>{billNumber}</h2>
