            ...
            if (data) {
                const mappedData: ReturnsData = {
                    rma: (data.RMA_Line__c || []).map((item: any) => ({
                        ...
                        manufacturerDBA: item.Manufacturer_DBA__c || "", unitPrice: item.Unit_Price__c || 0, returnQty: item.Return_Qty__c || 0,
                    ...
                    rtv: (data.RTV_Line__c || []).map((item: any) => ({
                        ...
                        manufacturerDBA: item.Manufacturer_DBA__c || "", unitCost: item.Unit_Cost__c || 0, returnQty: item.Return_Qty__c || 0,
                    ...
                    creditMemos: (data.Credit_Memo_Line__c || []).map((item: any) => ({
                        ...
                        manufacturerDBA: item.Manufacturer_DBA__c || "", unitPrice: item.Unit_Price__c || 0, creditQty: item.Credit_Qty__c || 0,
                    ...
                    debitMemos: (data.Debit_Memo_Line__c || []).map((item: any) => ({
                        ...
                        productName: item.Product_Name || "", productDescription: item.Product_Description__c || "",
                        manufacturerDBA: item.Manufacturer_DBA__c || "", unitCost: item.Unit_Cost__c || 0, debitQty: item.Debit_Qty__c || 0,
