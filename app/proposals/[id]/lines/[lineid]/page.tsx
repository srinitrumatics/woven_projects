            ...
            if (data) {
                const mappedData: FulfillmentData = {
                    invoices: (data.Invoice_Line__c || []).map((inv: any) => ({
                        ...
                        customerQuoteLineId: inv.Customer_Quote_Line__c || "",
                        ...
                        brand: inv.Product_Brand_Name__c || "-",
                        unitPrice: inv.Unit_Price__c || 0,
                        invoiceQty: inv.Invoiced_Qty__c || 0,
                        totalOrderQty: inv.Total_Order_Qty__c || inv.gtherp__Total_Order_Qty__c || 0,
                    ...
                    shippingManifests: (data.Shipping_Manifest_Line__c || []).map((sm: any) => ({
                        ...
                        shippingManifestName: sm.Shipping_Manifest_Name || "",
                        shippingManifestId: sm.Shipping_Manifest__c || "",
                        ...
                        customerQuoteLineId: sm.Customer_Quote_Line__c || "",
                        ...
                        brand: sm.Product_Brand_Name__c || "-",
                        boxCount: sm.Box__c || 0,
                        boxLength: sm.Case_Length__c || sm.gtherp__Case_Length__c || 0,
                        boxWidth: sm.Case_Width__c || sm.gtherp__Case_Width__c || 0,
                        boxHeight: sm.Case_Height__c || sm.gtherp__Case_Height__c || 0,
                    ...
                    salesOrders: (data.Sales_Order_Line__c || []).map((so: any) => ({
                        ...
                        customerQuoteLineId: so.Customer_Quote_Line__c || so.gtherp__Customer_Quote_Line__c || "",
                        ...
                        brand: so.Product_Brand_Name__c || "-",
                    ...
                    customerQuotes: (data.Customer_Quote_Line__c || []).map((cq: any) => ({
                        ...
                        brand: cq.Product_Brand_Name__c || "-",
            ...
            if (data) {
                const mappedData: ReturnsData = {
                    ...
                    creditMemos: (data.Credit_Memo_Line__c || []).map((item: any) => ({
                        ...
                        customerQuoteLineName: item.Customer_Quote_Line_Name || "",
                        customerQuoteId: item.Customer_Quote__c || "",
                        customerQuoteLineId: item.Customer_Quote_Line__c || item.gtherp__Customer_Quote_Line__c || "",
                        productName: item.Product_Name || "",
                        productDescription: item.Product_Description__c || "",
                        manufacturerDBA: item.Manufacturer_DBA__c || "",
                        brand: item.Product_Brand_Name__c || "-",
            ...
            < div className="grid grid-cols-1 w1025:grid-cols-5 gap-4" >
                ...
                < div className="w1025:col-span-5 bg-white dark:bg-gray-800 rounded-lg shadow-sm  overflow-hidden p-4" >
                    <div className="overflow-x-auto">
                        <Table className="text-left text-sm table-fixed">
                            <THead>
                                <tr>
                            ...
                            <TBody>
                                <Tr>
                                    <Td className="text-gray-600 font-medium truncate">
                                        ${unitPrice.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                    </Td>
                                    <Td className="text-gray-600 truncate">{quantity}</Td>
                                    <Td className="text-gray-600 truncate">{product.moq}</Td>
                                    <Td className="text-gray-600 truncate">{product.quantity}</Td>
                                    <Td className="text-gray-600 truncate">
                                    ...
                                    <Td className="font-bold text-primary dark:text-primary-light truncate">
                                        ${grandTotal.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                    </Td>
                                    <Td className="text-gray-600 truncate">{product.qtyShipped}</Td>
                                </Tr>
                            </TBody>
                        </Table>
                    </div>
