                ...
                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {products.map((product) => (
                        <tr key={product.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            ...
                            <td className="px-3 py-2 text-sm text-gray-900 dark:text-white font-medium text-left truncate" style={{ width: widths.productName }}>
                            ...
                            <td className="px-3 py-2 text-sm text-gray-900 dark:text-white text-left min-w-[186px] truncate" style={{ width: widths.description }}>
                                <div className="truncate" title={product.description || ''}>{product.description || '-'}</div>
                            </td>
                            <td className="px-3 py-2 text-sm text-gray-900 dark:text-white text-left min-w-[190px] truncate" style={{ width: widths.manufacturerDBA }}>
                                <div className="truncate" title={product.manufacturerDBA || ''}>{product.manufacturerDBA || '-'}</div>
                            </td>
                            <td className="px-3 py-2 text-sm text-gray-900 dark:text-white text-left truncate" style={{ width: widths.grouping }}>
                            ...
                            <td className="px-3 py-2 text-left truncate" style={{ width: widths.actions }}>
                                <Link href={`/proposals/${proposalId}/lines/${product.id}`} className="text-primary rounded font-medium inline-block truncate">
