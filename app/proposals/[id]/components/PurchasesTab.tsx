                            ...
                            {sortedPurchases.length === 0 ? (
                                ...
                                sortedPurchases.map((purchase) => (
                                    <tr key={purchase.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                        <td className="px-4 py-3 text-sm font-mono text-gray-900 dark:text-white font-medium" title={purchase.name}><div className="text-sm font-medium font-mono text-gray-900 dark:text-white line-clamp-2" title={purchase.name}>{purchase.name}</div></td>
                                        ...
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={purchase.customerQuoteName}>{purchase.customerQuoteName}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={purchase.customerOrderName}>{purchase.customerOrderName}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={purchase.customerPO}>{purchase.customerPO}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={purchase.supplierName}>{purchase.supplierName}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={purchase.supplierDBA}>{purchase.supplierDBA}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={purchase.supplierContact}>{purchase.supplierContact}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={purchase.shipToAccountName}>{purchase.shipToAccountName}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={purchase.shipToLocationName}>{purchase.shipToLocationName}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={purchase.shipToContactName}>{purchase.shipToContactName}</div></td>
                                        ...
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{purchase.issuedDate}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{purchase.acknowledgedDate}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{purchase.requestDate}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{purchase.promiseDate}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{purchase.shippingMethod}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{purchase.logisticsPartner}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{purchase.logisticsContact}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{purchase.trackingNumber}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{purchase.estimatedDeliveryDate}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{purchase.trackingStatus}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{purchase.actualDeliveryDate}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{purchase.goodsReceiptsDate}</div></td>
                                    </tr>
                                ))
                            )}
                        </tbody>
                            ...
                            {sortedBills.length === 0 ? (
                                ...
                                sortedBills.map((bill) => (
                                    <tr key={bill.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                        <td className="px-4 py-3 text-sm font-mono text-gray-900 dark:text-white font-medium" title={bill.name}><div className="text-sm font-medium font-mono text-gray-900 dark:text-white line-clamp-2" title={bill.name}>{bill.name}</div></td>
                                        <td className="px-4 py-3">
                                        ...
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={bill.purchaseOrderName}>{bill.purchaseOrderName}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={bill.customerQuoteName}>{bill.customerQuoteName}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={bill.customerOrderName}>{bill.customerOrderName}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={bill.supplierName}>{bill.supplierName}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={bill.supplierDBA}>{bill.supplierDBA}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-900 dark:text-white"><div className="text-sm text-gray-900 dark:text-white line-clamp-2" title={bill.supplierContact}>{bill.supplierContact}</div></td>
                                        <td className="px-4 py-3 text-center text-sm text-gray-900 dark:text-white">
                                            <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400 font-semibold">
                                                {bill.totalLines}
                                            </span>
                                        ...
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{bill.billedDate}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{bill.paymentTerms}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{bill.dueDate}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{bill.remittanceStatus}</div></td>
                                        <td className="px-4 py-3 text-sm text-right text-gray-900 dark:text-white">
                                            ${bill.openBalance?.toLocaleString('en-US', { minimumFractionDigits: 2 }) ?? '0.00'}
                                        </td>
                                        <td className="px-4 py-3 text-center text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{bill.daysOutstanding}</div></td>
                                        <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400"><div className="line-clamp-2">{bill.settledDate}</div></td>
                                    </tr>
                                ))
                            )}
                        </tbody>
