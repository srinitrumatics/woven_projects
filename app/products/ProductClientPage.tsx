        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${selectedFamily === "All"
                  ? "bg-primary text-white"
            ...
            {productFamilies.map((family) => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${selectedFamily === family
                    ? "bg-primary text-white"
                    : "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600"
                  }`}
              >
