...
export const mockProducts: Product[] = rawProducts.map((raw, index) => {
  // Generate a fake Salesforce-like ID (18 characters, starting with 01t)
  const randomId = '01t' + 'WL' + Math.random().toString(36).substring(2, 15).toUpperCase().padEnd(13, '0');
