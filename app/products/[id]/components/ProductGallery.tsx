...
export default function ProductGallery({ images }: ProductGalleryProps) {
  ...
  return (
    <div className="flex flex-col xl:flex-row gap-3 w-full h-full group">
      ...
      {/* Main Display Area */}
      <div className="relative flex-1 bg-primary-light dark:bg-gray-900 border border-blue-50 dark:border-gray-800 rounded-2xl flex items-center justify-center p-3 min-h-[220px] sm:min-h-[280px] xl:min-h-0 order-1 xl:order-2 overflow-hidden shadow-sm">
        {/* Main Image */}
        {!isPlaceholder ? (
          <img
            src={activeImage}
          ...
          <div className="flex flex-col items-center">
            <div className="w-14 h-14 md:w-20 md:h-20 rounded-xl bg-primary/40 flex items-center justify-center mb-1 shadow-inner border border-blue-200">
              <svg className="w-8 h-8 md:w-10 md:h-10 text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
