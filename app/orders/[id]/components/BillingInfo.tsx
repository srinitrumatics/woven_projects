                ...
                <div className="grid grid-cols-1 w1025:grid-cols-6 gap-4">
                    ...
                    <div className="w1025:col-span-3">
                        ...
                        <select name="billTo"
                            ...
                            disabled={!isEditing}
                            className={`w-full h-11 px-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent transition-all ${!isEditing ? 'bg-gray-100 dark:bg-gray-700 ' : 'bg-white dark:bg-gray-700'}`}
                        >
                    ...
                    <div className="w1025:col-span-2">
                        ...
                        <input
                            ...
                            className={`w-full h-11 px-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent transition-all placeholder-gray-400 truncate ${!isEditing ? 'bg-gray-100 dark:bg-gray-700 ' : 'bg-white dark:bg-gray-700'}`}
                        />
                    </div>
