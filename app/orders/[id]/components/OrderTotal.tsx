            ...
            <div className="mt-auto">
                ...
                <div className="border-t-2 border-primary/20 dark:border-primary/40 py-2">
                    <div className="flex justify-between items-center text-lg font-bold gap-4">
                        ...
                        <span className="text-primary dark:text-primary font-extrabold shrink-0">${grandTotal.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                    </div>
                </div>
