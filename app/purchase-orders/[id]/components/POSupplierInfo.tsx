            ...
            <div className="text-sm flex-1">
                <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                    ...
                    <div className="md:col-span-3 min-w-0">
                        <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5 " title="Bill to Account">Bill to Account</label>
                    ...
                    <div className="md:col-span-3 min-w-0">
                        <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5 " title="Bill to Location">
                            Bill to Location
                        </label>
                    ...
                    <div className="md:col-span-6 min-w-0">
                        <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5 " title="Billing Address">
                            Billing Address
                        </label>
                    ...
                    {/* Row 3 */}
                    <div className="md:col-span-3 min-w-0">
                        <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5 " title="Payment Terms">Payment Terms</label>
                    ...
                    <div className="md:col-span-3 min-w-0">
                        <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5 " title="Customer PO">
                            Customer PO
                        </label>
