        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-300">
                <div className="bg-primary/5 dark:bg-primary/10 px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center gap-3">
                    ...
                    <h2 className="text-lg font-bold text-gray-900 dark:text-white">Purchase Summary</h2>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-300">
                ...
                <div className="p-6 space-y-4">
                    <div>
                        <p className="text-lg font-bold text-gray-900 dark:text-white mb-0.5">{po.supplierName}</p>
                        {po.supplierDBA && <p className="text-sm font-semibold text-primary uppercase tracking-wide italic">{po.supplierDBA}</p>}
                    </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-300">
                <div className="bg-emerald-50 dark:bg-emerald-900/10 px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center gap-3">
                    ...
                    <h2 className="text-lg font-bold text-gray-900 dark:text-white">Shipping To</h2>
                </div>
                <div className="p-6 space-y-4">
                    <div>
                        <p className="text-lg font-bold text-gray-900 dark:text-white mb-0.5">{po.shipToAccountName}</p>
                        <p className="text-sm font-semibold text-emerald-600 dark:text-emerald-400">{po.shipToLocationName}</p>
                    </div>
                    ...
                    <div className="flex items-center gap-3 pt-3">
                        ...
                        <div>
                            <p className="text-sm font-bold text-gray-900 dark:text-white">Drop Ship</p>
                            <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest">{po.dropShip ? 'Enabled' : 'Disabled'}</p>
                        </div>
                    </div>
                </div>
            </div>
